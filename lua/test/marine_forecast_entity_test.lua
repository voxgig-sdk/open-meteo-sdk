...
describe("MarineForecastEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set OPEN_METEO_TEST_MARINE_FORECAST_ENTID JSON to run live")
      return
    end
...
function marine_forecast_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("OPEN_METEO_TEST_MARINE_FORECAST_ENTID")
