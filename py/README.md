# OpenMeteo Python SDK



The Python SDK for the OpenMeteo API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Historical()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/open-meteo-sdk/releases)) or
...
client = OpenMeteoSDK({
    "apikey": os.environ.get("OPEN_METEO_APIKEY"),
})
```
...
```
py/
├── openmeteo_sdk.py         -- Main SDK module
