...
class OpenMeteoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenMeteoTestRunner.getenv("OPENMETEO_TEST_LIVE")
        override = OpenMeteoTestRunner.getenv("OPENMETEO_TEST_OVERRIDE")
        ...
        explain = OpenMeteoTestRunner.getenv("OPENMETEO_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["OPENMETEO_TEST_EXPLAIN"] = explain
