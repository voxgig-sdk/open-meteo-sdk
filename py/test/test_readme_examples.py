# OpenMeteo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenMeteoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenMeteoSDK(...) and OpenMeteoSDK.test(...) become
#      OpenMeteoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openmeteo_sdk"
_SDK_CLASS = "OpenMeteoSDK"
...
_ENTITIES = {
    ...
    "MarineForecast": "marine_forecast",
