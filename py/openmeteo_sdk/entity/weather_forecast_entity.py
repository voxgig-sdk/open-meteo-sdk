...
from openmeteo_sdk.openmeteo_types import (
    WeatherForecast,
...
class WeatherForecastEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WeatherForecastEntity(self._client, opts)
    ...
    def data_get(self) -> WeatherForecast:
    ...
    def match_get(self) -> WeatherForecast:
