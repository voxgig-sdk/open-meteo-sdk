...
class MarineForecastEntity:
    ...
    def data_get(self) -> MarineForecast:
    ...
    def match_get(self) -> MarineForecast:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MarineForecast:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MarineForecast().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
