...
from openmeteo_sdk.utility import register

# Load features
from openmeteo_sdk.feature.base_feature import OpenMeteoBaseFeature
from openmeteo_sdk.features import _has_feature, _make_feature
...
class OpenMeteoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OpenMeteoUtility()
        self._utility = utility

        from openmeteo_sdk.config import shared_config
    ...
    def get_utility(self):
        return OpenMeteoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenMeteoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Historical(self, data=None) -> "HistoricalEntity":
        ...
        from openmeteo_sdk.entity.historical_entity import HistoricalEntity
    ...
    def MarineForecast(self, data=None) -> "MarineForecastEntity":
        ...
        from openmeteo_sdk.entity.marine_forecast_entity import MarineForecastEntity
    ...
    def WeatherForecast(self, data=None) -> "WeatherForecastEntity":
        ...
        from openmeteo_sdk.entity.weather_forecast_entity import WeatherForecastEntity
