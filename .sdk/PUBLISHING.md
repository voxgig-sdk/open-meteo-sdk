...
|---|---|---|
| `ts/` | @voxgig-sdk/open-meteo-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-meteo-sdk \
      --repository voxgig-sdk/open-meteo-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-meteo-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-meteo-sdk --id=<id>` removes it.
