...
class OpenMeteoProxyFeature extends OpenMeteoBaseFeature
{
    ...
    public function init(OpenMeteoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenMeteoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
