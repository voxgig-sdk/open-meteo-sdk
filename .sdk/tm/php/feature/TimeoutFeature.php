...
class OpenMeteoTimeoutFeature extends OpenMeteoBaseFeature
{
    ...
    private function _with_timeout(OpenMeteoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenMeteoContext $_ctx, float $ms): void
    {
        $client = $this->client;
