...
class OpenMeteoRbacFeature extends OpenMeteoBaseFeature
{
    ...
    private function _required(OpenMeteoContext $ctx): ?string
    {
    ...
    private function _reject(OpenMeteoContext $ctx, string $required): void
    {
    ...
    private function _track(OpenMeteoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
