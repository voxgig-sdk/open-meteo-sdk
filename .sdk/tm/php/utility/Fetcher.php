...
class OpenMeteoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenMeteoSDK/1.0)';
    ...
    public static function call(OpenMeteoContext $ctx, string $fullurl, array $fetchdef): array
    {
