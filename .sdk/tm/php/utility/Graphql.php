...
class OpenMeteoGraphql
{
    ...
    // equivalent.
    public static function body(OpenMeteoContext $ctx): mixed
    {
    ...
    public static function errors(OpenMeteoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
