...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = OpenMeteoOmni.make_runner(TEST_JSON_FILE, OpenMeteoSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : OpenMeteoOmni.errify(err)
    end
