...
class OpenMeteoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenMeteoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenMeteoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenMeteoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
