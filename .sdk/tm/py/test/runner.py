...
class OpenMeteoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenMeteoTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenMeteoTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenMeteoTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
