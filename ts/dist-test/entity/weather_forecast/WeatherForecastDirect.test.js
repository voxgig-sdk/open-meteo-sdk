...
(0, node_test_1.describe)('WeatherForecastDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenMeteoSDK({
    ...
    (0, node_test_1.test)('direct-load-weather_forecast', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-weather_forecast', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenMeteoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.OPEN_METEO_APIKEY,
        }));
        let idmap = env['OPEN_METEO_TEST_WEATHER_FORECAST_ENTID'];
    ...
    const client = new __1.OpenMeteoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WeatherForecastDirect.test.js.map