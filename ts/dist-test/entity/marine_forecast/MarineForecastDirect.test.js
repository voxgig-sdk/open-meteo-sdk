...
(0, node_test_1.describe)('MarineForecastDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-marine_forecast', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-marine_forecast', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPEN_METEO_TEST_MARINE_FORECAST_ENTID'];
...
//# sourceMappingURL=MarineForecastDirect.test.js.map