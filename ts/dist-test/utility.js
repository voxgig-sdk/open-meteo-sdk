...
function envOverride(m) {
    if ('TRUE' === process.env.OPEN_METEO_TEST_LIVE ||
        'TRUE' === process.env.OPEN_METEO_TEST_OVERRIDE) {
    ...
    m.OPEN_METEO_TEST_EXPLAIN = process.env.OPEN_METEO_TEST_EXPLAIN || m.OPEN_METEO_TEST_EXPLAIN;
    return m;
}
