...
exports.OpenMeteoEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends OpenMeteoEntityBase<Advice>`.
class OpenMeteoEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.OpenMeteoEntityBase = OpenMeteoEntityBase;
//# sourceMappingURL=OpenMeteoEntityBase.js.map