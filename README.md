...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/open-meteo` | `npm install @voxgig-sdk/open-meteo` |
| Python | `voxgig-sdk-open-meteo` | `pip install voxgig-sdk-open-meteo` |
| PHP | `voxgig-sdk/open-meteo` | `composer require voxgig-sdk/open-meteo` |
| Golang | `github.com/voxgig-sdk/open-meteo-sdk/go` | `go get github.com/voxgig-sdk/open-meteo-sdk/go` |
| Ruby | `voxgig-sdk-open-meteo` | `gem install voxgig-sdk-open-meteo` |
| Lua | `voxgig-sdk-open-meteo` | `luarocks install voxgig-sdk-open-meteo` |
