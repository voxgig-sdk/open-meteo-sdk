...
The PHP SDK for the OpenMeteo API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Historical(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->OpenMeteo(null)->load(
    ["id" => "test01"], null
);
