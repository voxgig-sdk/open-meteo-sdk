...
class MarineForecastEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarineForecastEntity($this->_client, $opts);
    }

    /**
     * @param MarineForecast|array $args MarineForecast data (assoc-array) to store.
     */
    ...
    /**
     * @return MarineForecast|array The current MarineForecast data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarineForecast fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarineForecast fields).
     */
    ...
    /**
     * Load a single MarineForecast.
     *
     * @param MarineForecastLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarineForecastLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarineForecast|array The loaded MarineForecast as an assoc-array at the
