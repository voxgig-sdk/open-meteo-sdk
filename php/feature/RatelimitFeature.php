...
// OpenMeteo SDK ratelimit feature
...
class OpenMeteoRatelimitFeature extends OpenMeteoBaseFeature
{
    ...
    private function _acquire(OpenMeteoContext $ctx): void
    {
    ...
    private function _track(OpenMeteoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
