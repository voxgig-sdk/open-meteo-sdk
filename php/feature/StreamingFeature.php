...
// OpenMeteo SDK streaming feature
...
class OpenMeteoStreamingFeature extends OpenMeteoBaseFeature
{
    ...
    private function _iterate(OpenMeteoResult $result): \Generator
    {
    ...
    private function _streamable(OpenMeteoContext $ctx): bool
    {
