...
// OpenMeteo SDK clienttrack feature
...
class OpenMeteoClienttrackFeature extends OpenMeteoBaseFeature
{
    ...
    public function PostConstruct(OpenMeteoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenMeteo-SDK';
