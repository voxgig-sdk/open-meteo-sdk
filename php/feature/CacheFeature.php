...
class OpenMeteoCacheFeature extends OpenMeteoBaseFeature
{
    ...
    private function _through(OpenMeteoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
