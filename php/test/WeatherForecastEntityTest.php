...
class WeatherForecastEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPEN_METEO_TEST_WEATHER_FORECAST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function weather_forecast_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPEN_METEO_TEST_WEATHER_FORECAST_ENTID");
