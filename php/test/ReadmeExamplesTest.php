...
// OpenMeteo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenMeteoSDK::test)
...
{
    private const SDK_CLASS = 'OpenMeteoSDK';
    ...
    private const SDK_BASE = 'openmeteo_sdk';
