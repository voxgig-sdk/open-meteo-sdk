...
func TestMarineForecastEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		marineForecastRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.marine_forecast")))
...
func marine_forecastBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("OPEN_METEO_TEST_MARINE_FORECAST_ENTID")
	...
	idmapResolved := core.ToMapAny(env["OPEN_METEO_TEST_MARINE_FORECAST_ENTID"])
