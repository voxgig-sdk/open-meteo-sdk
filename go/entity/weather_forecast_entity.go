...
type WeatherForecastEntity struct {
	name    string
...
func NewWeatherForecastEntity(client *core.OpenMeteoSDK, entopts map[string]any) *WeatherForecastEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WeatherForecastEntity) GetName() string { return e.name }
...
func (e *WeatherForecastEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WeatherForecastEntity) Deleted() bool {
	return e.deleted
}


func (e *WeatherForecastEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWeatherForecastEntity(e.client, opts)
}

func (e *WeatherForecastEntity) Data(args ...any) any {
...
func (e *WeatherForecastEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *WeatherForecastEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WeatherForecastEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WeatherForecastEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WeatherForecastEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WeatherForecastEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WeatherForecastEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
