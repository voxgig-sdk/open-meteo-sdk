...
```go
result, err := client.Historical(nil).Load(map[string]any{"end_date": "end_date", "latitude": 1, "longitude": 1, "start_date": "start_date"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.MarineForecast(nil).Load(map[string]any{"latitude": 1, "longitude": 1}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.WeatherForecast(nil).Load(map[string]any{"latitude": 1, "longitude": 1}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
