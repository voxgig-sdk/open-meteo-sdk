...
type Args struct {
	Entity string         `json:"entity" jsonschema:"historical | marine_forecast | weather_forecast"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenMeteoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-meteo_list",
		Description: "List records from OpenMeteo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-meteo_load",
		Description: "Load a single record from OpenMeteo. " +
...
func runOp(client *sdk.OpenMeteoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenMeteoSDK, name string) (sdk.OpenMeteoEntity, error) {
