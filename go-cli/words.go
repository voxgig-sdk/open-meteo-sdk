...
func registerSDKWords(r *eng.Registry, client *sdk.OpenMeteoSDK) {
...
func runOp(client *sdk.OpenMeteoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
