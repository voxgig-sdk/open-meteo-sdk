...
AQL-driven CLI and REPL for the OpenMeteo SDK. Positional arguments are
...
./open-meteo-cli list historical
./open-meteo-cli load 1 historical
./open-meteo-cli load '{id:1}' historical
