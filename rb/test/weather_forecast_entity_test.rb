...
class WeatherForecastEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OPEN_METEO_TEST_WEATHER_FORECAST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def weather_forecast_basic_setup(extra)
  ...
  entid_env_raw = ENV["OPEN_METEO_TEST_WEATHER_FORECAST_ENTID"]
