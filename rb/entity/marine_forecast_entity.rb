...
class MarineForecastEntity
  ...
  # @return [MarineForecast, Hash] the current MarineForecast data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MarineForecast fields)
  def match_get
  ...
  #
  # @param reqmatch [MarineForecastLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MarineForecast.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MarineForecast, Hash] the loaded MarineForecast; raises OpenMeteoError on failure
